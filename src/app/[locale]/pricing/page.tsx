...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Top-ups are one-time purchases that never expire; great if you research occasionally. Monthly ($59/mo) gives unlimited reports plus pro features and is the most cost-effective if you use the platform regularly.",
  },
  {
