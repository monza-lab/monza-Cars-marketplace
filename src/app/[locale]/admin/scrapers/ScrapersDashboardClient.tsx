...
const SCRAPER_LABELS: Record<ScraperName, string> = {
  ...
  "as24-enrich": "AS24 Enrichment",
  "classic-enrich": "Classic.com Enrichment",
  "bat-detail": "BaT Detail",
  validate: "Validator",
  cleanup: "Cleanup",
  "liveness-check": "Liveness Checker",
  "autotrader-delist-check": "AutoTrader Delist Check",
...
const SCRAPER_RUNTIME: Record<ScraperName, string> = {
  ...
  "as24-enrich": "GitHub Actions",
  "classic-enrich": "GitHub Actions",
  "bat-detail": "GitHub Actions",
  validate: "Vercel Cron",
  cleanup: "Vercel Cron",
  "liveness-check": "GitHub Actions",
  "autotrader-delist-check": "Windows Task",
