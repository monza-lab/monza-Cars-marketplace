...
export function NoMarketplaceBanner() {
  return (
    <div className="border-b border-border bg-foreground/[0.02]">
      <div className="max-w-[1600px] mx-auto px-3 md:px-6 py-1.5 md:py-2.5 flex items-center gap-2.5">
        ...
        <p className="text-[11px] md:text-[12px] text-muted-foreground leading-snug">
          <span className="md:hidden">Independent intelligence. Listings stay on their original marketplace.</span>
