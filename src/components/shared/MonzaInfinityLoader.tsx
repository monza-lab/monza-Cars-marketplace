...
export function MonzaInfinityLoader({ label = "Loading cars" }: { label?: string }) {
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-background">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[200px] rounded-full bg-primary/[0.04] blur-3xl" />

      {/* Infinity SVG */}
      <div className="relative w-full max-w-[320px] aspect-[2/1] text-primary">
      ...
      <div className="mt-6 flex flex-col items-center gap-2">
        <p className="text-[14px] font-medium tracking-wide text-primary/80">
          {label}
        </p>
        <div className="flex gap-1">
          <span className="size-1 rounded-full bg-primary/60 animate-bounce [animation-delay:0ms]" />
          <span className="size-1 rounded-full bg-primary/60 animate-bounce [animation-delay:150ms]" />
          <span className="size-1 rounded-full bg-primary/60 animate-bounce [animation-delay:300ms]" />
        </div>
      </div>
