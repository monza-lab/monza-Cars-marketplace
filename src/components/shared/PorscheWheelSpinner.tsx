...
export function PorscheWheelSpinner({
  ...
  return (
    <div
      className={`flex h-screen w-full flex-col items-center justify-center bg-background ${className ?? ""}`}
    >
      {/* Ring container */}
      <div className="relative flex items-center justify-center" style={{ width: 64, height: 64 }}>
        ...
        <motion.div
          ...
          style={{
            background: "radial-gradient(circle, rgba(var(--glow-color),0.06) 0%, transparent 70%)",
          }}
      ...
      {/* Brand text */}
      <motion.span
        className="mt-8 text-[11px] font-light tracking-[0.35em] text-primary/50"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
