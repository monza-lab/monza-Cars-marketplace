...
4. **Locale discipline.** The user prompt specifies a locale (`en`, `es`, `de`, or `ja`). Every string in your output must be in that locale, following the register described in the locale notes. Do not mix languages.
