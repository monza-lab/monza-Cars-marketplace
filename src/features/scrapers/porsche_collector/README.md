# Luxury Collector (Porsche-first)

Collect luxury listings from existing scrapers (BaT, Cars & Bids, Collecting Cars) and persist into Supabase tables described in `BASE_DATOS_COMPLETA_TODOS_LUJO.md`.
