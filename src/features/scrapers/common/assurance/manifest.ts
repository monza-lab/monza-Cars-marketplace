...
export const SCRAPER_JOBS: readonly AssuranceJob[] = [
  ...
  job("enrich-beforward", "enrich-beforward", "BeForward Enrichment", "enrichment", ["BeForward"], ["scripts/bf-enrich-cli.ts"], { cadence: "external", workflows: ["beforward-enrich.yml"] }),
