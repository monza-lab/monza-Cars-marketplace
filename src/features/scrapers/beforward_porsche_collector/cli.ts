...
function usage(): string {
  return [
    ...
    "  npx tsx src/features/beforward_porsche_collector/cli.ts --dryRun --maxPages=200 --maxDetails=10000 --concurrency=3",
    "",
    "Persist to Supabase:",
    "  npx tsx src/features/beforward_porsche_collector/cli.ts --maxPages=200 --maxDetails=10000 --concurrency=3",
    "",
    "Common flags:",
    "  --startPage=1",
    "  --timeoutMs=20000",
...
async function main(): Promise<void> {
  ...
  const config: CollectorRunConfig = {
    ...
    concurrency: readNumber(args, "concurrency", 3),
    rateLimitMs: readNumber(args, "rateLimitMs", 4000),
