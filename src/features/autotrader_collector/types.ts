...
export type SourceKey = "AutoTrader";

export type PlatformEnum = "AUTO_TRADER";
...
export interface NormalizedListing {
  ...
  endTime: Date | null;
  startTime: Date | null;
  reserveStatus: null; // AutoTrader is not auction-based
  ...
  reserveMet: null; // AutoTrader is not auction-based

  listDate: string | null; // YYYY-MM-DD
  saleDate: string | null; // YYYY-MM-DD (not applicable for marketplace)
  auctionDate: null; // AutoTrader is not auction-based

  auctionHouse: string; // "AutoTrader UK"
